                    ...
                    <div class="img h-full sm:flex w-full gap-4 overflow-y-auto sm:overflow-hidden">
                        <div class="w-full h-full flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="space-y-2">
                                    <div>
                                        <p class="text-sm">Showing <span class="showing">0</span> of <span class="count-media">0</span> media items</p>
                                    </div>
                                    <div class="flex items-center gap-2 justify-center">
                                        <button type="button" data-page="1" class="btn-load-more-media inline-flex items-center gap-x-1.5 rounded-md bg-indigo-600 px-2.5 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
