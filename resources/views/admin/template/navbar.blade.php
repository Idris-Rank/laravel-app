        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <div class="relative">
                <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                    ...
                    <img class="size-8 rounded-full bg-gray-50 object-cover"
                ...
                <div class="absolute hidden right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-hidden"
                    ...
                    <a href="{{ route('admin-user-edit', ['id' => Auth::user()->id]) }}" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1"
                        id="user-menu-item-0">Your profile</a>
                    <a href="{{ route('auth-admin-logout') }}" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1"
