...
<div class="container-media space-y-4">
    <div>
    ...
    <div class="space-y-6">
        <div class="flex items-center w-full justify-between">
            <div>
                <select id="media-type" name="media_type" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <form action="" method="POST">
                <div class="flex gap-4 items-center">
                    <div>
                        <input type="search" name="s" id="search_media" value="" autocomplete="off" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                    </div>
        ...
        <div class="media-list grid grid-cols-12 gap-4">
            ...
            <div class="media col-span-2">
                <div class="btn-detail-media border cursor-pointer rounded-lg overflow-hidden">
                    <img data-media-id="{{ $media_id }}" class="object-cover w-full h-36" src="{{ $guid }}" alt="{{ $title }}">
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="flex items-center justify-center">
            <div class="space-y-2">
                <div>
                    <p class="text-sm">Showing <span class="showing">{{ $medias->count() }}</span> of <span class="count-media">{{ $count_media }}</span> media items</p>
                </div>
                <div class="flex items-center gap-2 justify-center">
                    <button type="button" data-page="2" class="btn-load-more-media inline-flex items-center gap-x-1.5 rounded-md bg-indigo-600 px-2.5 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
